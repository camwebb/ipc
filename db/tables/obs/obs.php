...
class tables_obs {
    ...
    function det1_raw__htmlValue(&$record){
        return $record->val('det1_raw').'    (<a target="_blank" href="mailto:randiagusti@gmail.com?subject=IPC%20obs%20'.$record->val('id') . '">Sila kirim determinasi ttg obs # '. $record->val('id') .'</a>)';
    }
